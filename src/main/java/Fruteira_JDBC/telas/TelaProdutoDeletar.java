 ...
 */
public class TelaProdutoDeletar extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeletar
     */
    public TelaProdutoDeletar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaProdutoDeletar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
